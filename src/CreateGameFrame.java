 ...
 */
public class CreateGameFrame extends MyParentFrame {
    ...
    public CreateGameFrame(IModel model, IController controller){
        ...
        startButton.setLocation(80,900);
    ...
    public void refresh() {
        ...
        startButton.setEnabled(readyCheckBox.isSelected() && model.getGame().isOpponentReady());
    }
}
